...
export default async function SetPasswordDirectPage(props: SetPasswordPageProps) {
  ...
  // If code or token_hash arrived on /set-password, exchange session on server
  if (code) {
