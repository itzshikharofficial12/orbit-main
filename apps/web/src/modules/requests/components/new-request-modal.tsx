  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        role="dialog"
        aria-modal="true"
        className="relative w-full max-w-lg max-h-[calc(100dvh-1.5rem)] sm:max-h-[90vh] overflow-y-auto rounded-xl border border-border/80 bg-card p-4 sm:p-6 shadow-2xl z-50 animate-in fade-in-0 zoom-in-95 duration-150 space-y-4 sm:space-y-5"
      >
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              ...
              {CATEGORIES.map((cat) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 p-2.5 sm:p-2 rounded-lg border text-left transition-all cursor-pointer min-h-[40px] ${
                      isSelected
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full h-10 sm:h-8 px-2.5 text-sm sm:text-xs rounded-lg border border-border/80 bg-background text-foreground focus:outline-none focus:ring-1 focus:ring-ring"
                >
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              className="text-sm sm:text-xs h-10 sm:h-8"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`flex-1 py-2 sm:py-1.5 px-2.5 rounded-lg text-xs border transition-colors cursor-pointer min-h-[40px] sm:min-h-0 ${
                  priority === "LOW"
          ...
          <div className="flex items-center justify-between pt-3 border-t border-border/60 gap-2">
            ...
            <Button
              ...
              className="text-xs h-10 sm:h-8 gap-1.5 bg-primary text-primary-foreground hover:bg-primary/90 font-semibold cursor-pointer min-h-[44px] sm:min-h-0"
            >
              {isSubmitting ? (
